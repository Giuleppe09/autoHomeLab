    ...
    def get_k3s_config(self):
        ...
        if os.path.exists(secrets_path):
            with open(secrets_path, 'r') as f:
                k3s_secrets = yaml.safe_load(f) or {}
                
        return k3s_vars, k3s_secrets

    def save_k3s_config(self, vars_data, secrets_data):
        """Salva i dizionari nei rispettivi file YAML (mergiando con i dati esistenti)"""
        existing_vars, existing_secrets = self.get_k3s_config()
